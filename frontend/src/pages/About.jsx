...
const About = () => {
  ...
  return (
    <div style={containerStyle}>
      <img src="/dp.jpg" alt="Vinod Kumar"
      ...
      <h3 style={{ fontSize: '1.5rem', color: '#f97316', marginBottom: '15px' }}>Vinod Kumar</h3>
      <p style={{ color: '#a1a1aa', fontSize: '1.2rem', lineHeight: '1.8', maxWidth: '600px', margin: '0 auto 30px auto' }}>
        Welcome to <strong style={{ color: '#fff' }}>EasyCart</strong> — a modern e-commerce platform built with passion.
